...
function Contexts({ children }) {
  const [myContexts, setMyContexts] = useState({
    ...
    classes: [
      { id: "34JKS5OS", grade: "4", letter: "a", name: "Jyderup Skole", joinCode: "34JKS5OS", students: 24, allStudents: listOfStudents, bestSubject: "Brøker", worstSubject: "Division" },
      { id: "78IED37K", grade: "4", letter: "b", name: "Jyderup Skole", joinCode: "78IED37K", students: 23, allStudents: listOfStudents, bestSubject: "Division", worstSubject: "Brøker" },
      { id: "99DJK69S", grade: "4", letter: "c", name: "Jyderup Skole", joinCode: "99DJK69S", students: 28, allStudents: listOfStudents, bestSubject: "Addition", worstSubject: "Subtraktion" },
      { id: "13QWS47J", grade: "5", letter: "a", name: "Jyderup Skole", joinCode: "13QWS47J", students: 32, allStudents: listOfStudents, bestSubject: "Subtraktion", worstSubject: "Division" },
      { id: "74OIR44X", grade: "6", letter: "x", name: "Jyderup Skole", joinCode: "74OIR44X", students: 30, allStudents: listOfStudents, bestSubject: "Brøker", worstSubject: "Division" },
    ],
    selectedClass: "",
