  ...
  return (
    <div id="dashboardContainer" className={styles.dashboardContainer}>
      <div className={`${styles.dashboardMenu} ${burgerMenu ? styles.dashboardBurger : ""}`}>
        <button
          id={dashboardType === "Hjem" ? styles.activeDashboard : ""}
          value="Hjem"
          onClick={(e) => {
        ...
        <button
          id={dashboardType === "Statistik" ? styles.activeDashboard : ""}
          value="Statistik"
          onClick={(e) => {
            setDashboardType(e.currentTarget.value);
            burgerMenuClicked();
        ...
        <button
          id={dashboardType === "Milepæle" ? styles.activeDashboard : ""}
          value="Milepæle"
          onClick={(e) => {
            setDashboardType(e.currentTarget.value);
            burgerMenuClicked();
        ...
        <button
          id={dashboardType === "Scoreboard" ? styles.activeDashboard : ""}
          value="Scoreboard"
          onClick={(e) => {
            setDashboardType(e.currentTarget.value);
            burgerMenuClicked();
        ...
        >
          <a href="#dashboardContainer">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-trophy-fill" viewBox="0 0 16 16">
      ...
      <div className={styles.dashboard}>
        <div id="dashboardHeader" className={styles.dashboardHeader}>
          <h1 id={dashboardType}>{dashboardType}</h1>
